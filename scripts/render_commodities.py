# -*- coding: utf-8 -*-
"""
data/commodities.json から、主要資源の期間別チャートページ(docs/commodities.html)を生成する。
"""
import os
import json
...
IN_PATH = os.path.join(BASE_DIR, "data", "commodities.json")
OUT_PATH = os.path.join(BASE_DIR, "docs", "commodities.html")
...
<body>
  ...
  <nav class="nav-secondary">
    ...
    <a href="commodities.html" class="active">資源</a>
  </nav>
  <h1>資源</h1>
